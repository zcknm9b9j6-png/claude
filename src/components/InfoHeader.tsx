...
const QUOTES = [
  ...
  "You can't pour from an empty cup — look after you, too.",
  "The smallest moments often make the biggest difference.",
  "Lead with patience; it sets the tone for everyone.",
  "Today is a fresh page — make it a good one.",
  "Consistency beats intensity every time.",
  "Children learn more from who you are than what you say.",
  "One kind word can change someone's whole day.",
  "You've handled every hard day so far — that's a 100% record.",
  "Calm minds make clear decisions.",
  "Celebrate the small wins; they're wins all the same.",
  "Your effort today is someone's good memory tomorrow.",
  "A tidy plan makes a busy day feel lighter.",
  "Trust the process and keep showing up.",
  "Every challenge is a chance to grow.",
  "Good leaders build people up, one moment at a time.",
  "Take a breath. You're doing better than you think.",
  "Routines create safety; safety lets children thrive.",
  "Be kind to yourself — you're learning, too.",
  "Hard work quietly becomes great work.",
  "The energy you bring sets the mood for the whole room.",
  "Finish what matters; let go of what doesn't.",
  "Little hands remember big hearts.",
  "Stay curious — there's always a better way to do it.",
  "You make ordinary days feel special for someone.",
  "Rest is productive, too. Give yourself permission.",
  "Plant patience today and watch confidence grow.",
];
